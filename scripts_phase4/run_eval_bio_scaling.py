"""Scaling experiment bio-axis eval: reconstruct an E2B/E4B CPT model by TAG,
score the 3 bio loglikelihood tasks. Mirrors run_eval_bio.py but uses
scaling_load (dense model, no router).
"""
...
from scaling_load import load_scaling_model  # noqa: E402
