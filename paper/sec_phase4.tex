...
The full-CPT lineage shows a clean, large effect: mean biology-vs-language routing divergence
rises from $0.219$ (it-bio, no CPT) to $0.451$ (BioCPT, $8.7$B tokens) --- full CPT visibly
reorganizes which experts serve which modality (Figure~\ref{fig:p4router}). The Phase-2 mixture
sweep tells a different story. Despite the clear capability dose-response of
