...
next step now that the lever itself is established. Part III is deliberately narrow: one small
model (GPT-2, $124$M), one continuation recipe, and a character-level probe battery that is
...
intermediate scales between $124$M and $26$B, and whether the long-range-discourse cost can be
mitigated by a lower biological share or an NL-replay schedule, are the immediate next steps for
this line of the mixture-pretraining program.
